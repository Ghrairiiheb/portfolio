...
document.addEventListener("DOMContentLoaded", () => {
  ...
  downloadButtons.forEach((button) => {
    button.addEventListener("click", (e) => {
      ...
      link.href = "cv.pdf" // Assurez-vous que le fichier CV existe
      link.download = "CV-Iheb-Ghrairi.pdf"
  ...
  if (contactBtn) {
    contactBtn.addEventListener("click", (e) => {
      e.preventDefault()
      window.location.href = "mailto:ihebghrarii@gmail.com?subject=Contact depuis le portfolio&body=Bonjour Iheb,"
    })
  }
